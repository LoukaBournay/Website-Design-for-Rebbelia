...
const NODES: NodeData[] = [
  {
    ...
    color: '#1E4E8C',
    label: 'Demande reçue', sub: 'Email ou formulaire',
    icon: <IconWebhook />,
  },
  {
    id: 'json', cx: 215, cy: 160,
    color: '#D4A64A',
    label: 'Informations extraites', sub: 'Besoin et coordonnées',
    icon: <IconJson />,
  },
  {
    id: 'router', cx: 358, cy: 160,
    color: '#2F7A5F',
    label: 'Traitement adapté', sub: 'Selon votre procédure',
    icon: <IconRouter />,
  },
  {
    id: 'ai', cx: 498, cy: 78,
    color: '#1E4E8C',
    label: 'Réponse préparée', sub: 'Avec le bon contexte',
    icon: <IconAI />,
  },
  {
    id: 'email', cx: 630, cy: 78,
    color: '#D4A64A',
    label: 'Réponse envoyée', sub: 'Ou à valider',
    icon: <IconEmail />,
  },
  {
    id: 'http', cx: 498, cy: 242,
    color: '#2F7A5F',
    label: 'Vos outils vérifiés', sub: 'CRM ou base de données',
    icon: <IconHttp />,
  },
  {
    id: 'slack', cx: 630, cy: 242,
    color: '#1E4E8C',
    label: 'Équipe informée', sub: 'Notification de suivi',
    icon: <IconSlack />,
  },
]
